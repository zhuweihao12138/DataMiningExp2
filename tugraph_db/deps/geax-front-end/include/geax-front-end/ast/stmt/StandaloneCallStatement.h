...
#ifndef GEAXFRONTEND_AST_STMT_STANDALONECALLSTATEMENT_H_
#define GEAXFRONTEND_AST_STMT_STANDALONECALLSTATEMENT_H_
...
#endif  // GEAXFRONTEND_AST_STMT_STANDALONECALLSTATEMENT_H_
