...
import com.antgroup.tugraph.ogm.context.MappedRelationship;
...
import com.antgroup.tugraph.ogm.session.event.PostSaveEvent;
import com.antgroup.tugraph.ogm.session.event.PreSaveEvent;
...
final class SaveEventDelegate extends SessionDelegate {
    ...
    private void mapInstance(
        ...
        String type = reader.relationshipType();
        Relationship.Direction direction = reader.relationshipDirection();
