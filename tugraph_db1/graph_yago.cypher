...
CALL db.addLabel('Person', 'name', STRING, false, 'birthyear', INT16, true);
CALL db.addLabel('City', 'name', STRING, false);
CALL db.addLabel('Film', 'title', STRING, false);
CALL db.addType('HAS_CHILD');
CALL db.addType('MARRIED');
CALL db.addType('BORN_IN');
CALL db.addType('DIRECTED');
CALL db.addType('WROTE_MUSIC_FOR');
CALL db.addType('ACTED_IN', 'charactername', STRING, false);
CALL db.addIndex('Person', 'name', true);
