 ...
 * @returns
 */
export const StyleBtn: React.FC<StepUIProps> = ({
  prev,
  next,
  end,
  x = 0,
    ...
    <div className={styles.styleBtn} style={{ top: y, left: x }}>
      <div className={styles.container}>
        <img
          ...
          style={{ width: 365, top: 0, left: 0 }}
          src={Assets.styleBtn}
        />
        <img
          className={styles.background}
          style={{ width: 365, top: canvasY - y, left: canvasX - x }}
          src={Assets.afterSpread}
        />
 ...
 * @returns
 */
export const StylePanel: React.FC<StepUIProps> = ({
  prev,
  next,
  end,
  x = 0,
    ...
    <div className={styles.stylePanel} style={{ top: y, left: x }}>
      <div className={styles.container}>
        <img
          className={styles.background}
          style={{ width: 384 }}
          src={Assets.stylePanel}
        />
        <img
          className={styles.background}
          style={{ top: canvasY - y, left: canvasX - x }}
          src={Assets.afterStyle}
        />
        <img
          className={styles.gif}
          src={Assets.styleGif}
          style={{ top: 55, left: 50, maxWidth: 273 }}
        />
