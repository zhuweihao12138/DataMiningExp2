 ...
 * <p>
 * In case you want to use a composite index together with a {@link MapCompositeConverter}, than the following requirements apply:
 * <ul>
 *     <li>The {@link MapCompositeConverter} must always use the same keys (properties).</li>
