 ...
 */
package com.antgroup.tugraph.ogm.typeconversion;

import static java.util.Collections.emptyMap;
import static java.util.stream.Collectors.collectingAndThen;
import static java.util.stream.Collectors.toSet;
import static com.antgroup.tugraph.ogm.annotation.Properties.NoopTransformation;
import static com.antgroup.tugraph.ogm.annotation.Properties.Phase;
//import static com.antgroup.tugraph.support.ClassUtils.isEnum;
...
public class MapCompositeConverter implements CompositeAttributeConverter<Map<?, ?>> {
    ...
    private String keyInstanceToString(Object propertyKey) {
        ...
        } else if (ClassUtils.isEnum(propertyKey)) {
    ...
    private Object keyInstanceFromString(String propertyKey, Class<?> keyType) {
        if (keyType == null) {
            ...
            return propertyKey;
        } else if (ClassUtils.isEnum(keyType)) {
