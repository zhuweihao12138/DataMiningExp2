...
import com.antgroup.tugraph.ogm.session.request.FilteredQuery;
import com.antgroup.tugraph.ogm.session.request.FilteredQueryBuilder;
...
public class NodeQueryStatements<ID extends Serializable> implements QueryStatements<ID> {
    ...
    /**
     * Some arbitrary characters that hopefully are not used in a {@link Property @Property}.
     ...
     * (the name of the property annotated with {@link Id @Id}
     * or {@link Index @Index}.
     */
