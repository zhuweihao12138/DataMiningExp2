 ...
 */
package com.antgroup.tugraph.ogm.metadata.reflect;
...
import com.antgroup.tugraph.ogm.context.DirectedRelationship;
import com.antgroup.tugraph.ogm.context.DirectedRelationshipForType;
import com.antgroup.tugraph.ogm.session.Utils;
import com.antgroup.tugraph.ogm.support.ClassUtils;
import com.antgroup.tugraph.ogm.support.CollectionUtils;
import com.antgroup.tugraph.ogm.metadata.AnnotationInfo;
import com.antgroup.tugraph.ogm.metadata.ClassInfo;
import com.antgroup.tugraph.ogm.metadata.DescriptorMappings;
...
public class EntityAccessManager {
    ...
    private static Object stringToCharacterIterable(Object value, Class parameterType, Class elementType) {
        ...
        if (value.getClass().isArray() && (elementType == String.class || ClassUtils.isEnum(elementType))) {
            String[] strings = (String[]) value;
    ...
    public static FieldInfo getRelationalWriter(ClassInfo classInfo, String relationshipType,
                                                Relationship.Direction relationshipDirection, Object scalarValue) {
     ...
     */
    public static FieldInfo getRelationalWriter(ClassInfo classInfo, String relationshipType,
                                                Relationship.Direction relationshipDirection, Class<?> objectType) {
        ...
        while (classInfo != null) {
            ...
            if (relationshipDirection != Relationship.Direction.INCOMING) {
                ...
                if (fieldInfos.size() == 1) {
                    ...
                    if (candidateField.relationshipDirectionOrDefault(Relationship.Direction.UNDIRECTED) != Relationship.Direction.INCOMING) {
    ...
    private static FieldInfo getIterableFieldInfo(ClassInfo classInfo, Class<?> parameterType, String relationshipType,
                                                  Relationship.Direction relationshipDirection, boolean strict) {
            ...
            if (fieldInfos.size() == 1) {
                ...
                if (relationshipDirection == Relationship.Direction.INCOMING &&
                    candidateFieldInfo.relationshipDirectionOrDefault(Relationship.Direction.OUTGOING) == Relationship.Direction.INCOMING ||
                    candidateFieldInfo.relationshipDirectionOrDefault(Relationship.Direction.OUTGOING) == Relationship.Direction.UNDIRECTED) {
                    return candidateFieldInfo;
                }
                // If the relationshipDirection is not incoming and the candidateFieldInfo is not incoming
                if (relationshipDirection != Relationship.Direction.INCOMING && candidateFieldInfo
                    .relationshipDirectionOrDefault(Relationship.Direction.OUTGOING) != Relationship.Direction.INCOMING) {
                    return candidateFieldInfo;
                }
            }
    ...
    private static void cacheIterableFieldWriter(ClassInfo classInfo, Class<?> parameterType, String relationshipType,
                                                 Relationship.Direction relationshipDirection, DirectedRelationshipForType directedRelationshipForType, FieldInfo fieldInfo,
