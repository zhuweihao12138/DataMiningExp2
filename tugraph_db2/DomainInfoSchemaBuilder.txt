...
import com.antgroup.tugraph.ogm.metadata.DomainInfo;
...
public class DomainInfoSchemaBuilder {
        ...
        for (ClassInfo classInfo : classInfoMap.values()) {
            ...
            if (!classInfo.isRelationshipEntity()) {
                ...
                if (schema.getRelationship(type) == null) {
                    ...
                    schema.addRelationship(new RelationshipImpl(type, com.antgroup.tugraph.ogm.annotation.Relationship.Direction.OUTGOING, start, end));
                }
            }
        }
    }
    ...
    private void createRelationship(NodeImpl fromNode, FieldInfo relFieldInfo) {
        ...
        if (otherClassInfo.isRelationshipEntity()) {
            ...
            if (relFieldInfo.relationshipDirection() == Relationship.Direction.OUTGOING) {
