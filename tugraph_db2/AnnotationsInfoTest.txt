...
import com.antgroup.tugraph.ogm.domain.gh827.UnrelatedClass;
...
public class AnnotationsInfoTest {
    ...
    public void shouldBeAbleToHandlePackagePrivateAnnotations() {
        ...
        assertThat(info.get("com.antgroup.tugraph.ogm.domain.gh827.PackagePrivateAnnotation").get("value")).isEqualTo("v");
    }
}
