...
import com.antgroup.tugraph.ogm.metadata.schema.Node;
import com.antgroup.tugraph.ogm.metadata.schema.Relationship;
import com.antgroup.tugraph.ogm.metadata.schema.Schema;
...
public abstract class AbstractSchemaLoadClauseBuilder {
    ...
    private void listComprehension(StringBuilder sb, String fromNodeVar,
        ...
        com.antgroup.tugraph.ogm.annotation.Relationship.Direction direction = relationship.direction(node);
