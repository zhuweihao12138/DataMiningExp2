...
import com.antgroup.tugraph.ogm.cypher.FilterWithRelationship;
import com.antgroup.tugraph.ogm.cypher.query.SortClause;
...
abstract class SessionDelegate {
    ...
    private void updateRelationship(FilterWithRelationship filter, FieldInfo fieldInfo, String relationshipType) {
        ...
        filter.setRelationshipDirection(Relationship.Direction.UNDIRECTED);
        if (fieldInfo.getAnnotations() != null) {
            ...
            if (annotation != null) {
                ...
                Relationship.Direction direction = Relationship.Direction
                    .valueOf(annotation.get(Relationship.DIRECTION, Relationship.Direction.UNDIRECTED.name()));
            ...
            if (fieldInfo.getAnnotations().get(EndNode.class) != null) {
                filter.setRelationshipDirection(Relationship.Direction.INCOMING);
            }
        }
    }
